...
<html lang="zh-CN">
    ...
    <body>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="age" value = ${contact.age}  name="age" placeholder="请输入年龄" />
      </div>

      <div class="form-group">
        <label for="address">籍贯：</label>
	     <select name="address" class="form-control" >
	        <option value= <c:if test="${contact.address == '广东'}">selected="selected"
            </c:if>>广东</option>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" value = ${contact.email} name="email" placeholder="请输入邮箱地址"/>
      </div>
